...
urlpatterns = [
    ...
    path('viewall/modify', views.modify_reservation, name='modify_reservation'),
    path('viewall/checkin', views.checkin_reservation, name='checkin_reservation'),
    path('viewall/remove', views.remove_reservation, name='remove_reservation'),
