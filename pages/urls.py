...
urlpatterns = [
    ...
    path('viewall/modify/<int:reservation_id>/', views.modify_reservation, name='modify_reservation'),
    path('viewall/checkin/<int:reservation_id>/', views.checkin_reservation, name='checkin_reservation'),
    path('viewall/remove/<int:reservation_id>/', views.remove_reservation, name='remove_reservation'),
    path('reservation/confirm/<int:reservation_id>/', views.confirm_reservation, name='confirm_reservation'),
